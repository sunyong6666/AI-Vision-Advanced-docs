# WiFi Stream
<font style="color:rgba(0, 0, 0, 0.85) !important;">Before use, ensure you have a 2.4GHz Wi-Fi network. Then, select the Wi-Fi video transmission mode on the AI Vision Sensor using the dial button.  </font>
